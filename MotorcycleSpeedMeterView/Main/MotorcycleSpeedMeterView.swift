//
//  MotorcycleSpeedMeterView.swift
...
class MotorcycleSpeedMeterView: UIView {
...
//        context.setShouldAntialias(true)
    ...
    private func sizeOf(string: String, _ font: UIFont) -> CGSize {
        return string.size(withAttributes: [NSAttributedString.Key.font: font])
    }
}

extension MotorcycleSpeedMeterView: CAAnimationDelegate {
...
extension MotorcycleSpeedMeterView {
    func drawBigSeparator(in context: CGContext) {
        ...
        while currentRadians <= endRadians + pow(10, -10) {
            ...
            let valueLabelSize = sizeOf(string: valueLabel, valueFont)
